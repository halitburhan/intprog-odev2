          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="col-md-6">
                <h3 class="card-title">Şube Ekleme İşlemleri</h3></div>
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="POST" action="<?php echo base_url("Branches_Controller/save")?>">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="category" class="col-sm-2 col-form-label">Şube Adı</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="title" name="title" placeholder="şube adı gir">
                    </div>
                  </div>
                  <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="adress" name="adress" placeholder="adresi gir">
                    </div>
                  </div>
