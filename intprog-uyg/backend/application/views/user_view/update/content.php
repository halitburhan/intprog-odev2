        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <!-- form start -->
              <form class="form-horizontal" method="POST" action="<?php echo base_url("User_Controller/update/$item->id")?>">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="email" class="col-sm-2 col-form-label">Kullanıcı Maili:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="email" name="email" placeholder="mailini gir" value="<?php echo isset($item->email) ? $item->email : ''; ?>">
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="name" name="name" placeholder="adını gir" value="<?php echo isset($item->name) ? $item->name : ''; ?>">
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="surname" name="surname" placeholder="soyadını gir" value="<?php echo isset($item->surname) ? $item->surname : ''; ?>">
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="password" name="password" placeholder="şifre gir" value="<?php echo isset($item->password) ? $item->password : ''; ?>">
                    </div>
                  </div>
